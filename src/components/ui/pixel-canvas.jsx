...
class PixelCanvasElement extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this._onMouseEnter = () => this.handleAnimation('appear')
    this._onMouseLeave = () => this.handleAnimation('disappear')
    this._onFocus     = () => this.handleAnimation('appear')
    this._onBlur      = () => this.handleAnimation('disappear')

    this._parent?.addEventListener('mouseenter', this._onMouseEnter)
    this._parent?.addEventListener('mouseleave', this._onMouseLeave)
    if (!this.noFocus) {
  ...
  disconnectedCallback() {
    ...
    this._parent?.removeEventListener('mouseenter', this._onMouseEnter)
    this._parent?.removeEventListener('mouseleave', this._onMouseLeave)
    if (!this.noFocus) {
